...
$start_tree_id = $__APPLICATION_['session']->user->userDetail['sys']['start_tree_id'];


/* do all application stuff here replace channel template values */
$module = new module(array('in'=>array('sys_tree_id'=>$start_tree_id,'sys_skin_id'=>3,'childDepth'=>0,'mode'=>$mode)),'tree');
