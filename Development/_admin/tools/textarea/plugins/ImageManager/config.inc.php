<?
include_once('../../../.citadel.config.conf');
/**
 * Image Manager configuration file.
 * @author $Author: mare $
 * @version $Id: config.inc.php,v 1.1 2005/07/10 22:23:44 mare Exp $
...
*/
$IMConfig['base_dir'] = $GLOBALS['__CONFIG_']['__paths_']['__installationPath_'].'/clients'.$GLOBALS['__CONFIG_']['__paths_']['__clientPath_'].'/'.$GLOBALS['__CONFIG_']['__paths_']['__httpPath_'].'/images';
...
*/
$IMConfig['base_url'] = $GLOBALS['__CONFIG_']['__paths_']['__urlPath_'].'/images';
