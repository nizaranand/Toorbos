...
error_log($__CONFIG_['__paths_']['__rootPath_']);

error_log("IMAGE PATH NICUPLOAD:".$GLOBALS['__CONFIG_']['__paths_']['__rootPath_'].'/images');

define('NICUPLOAD_PATH', $GLOBALS['__CONFIG_']['__paths_']['__rootPath_'].'/images'); // Set the path (relative or absolute) to
