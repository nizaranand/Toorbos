...
$destinationPath = '/export/Fiber/clients'.$destinationPath.''.$filename;

error_log(move_uploaded_file($_FILES['Filedata']['tmp_name'],$destinationPath)."\n".$destinationPath,3,"/tmp/test.log");
...
if( $resourceID!=0 && $resourceID!="" ){
 ...
 $message =  "<result><status>OK</status><message>$filename uploaded successfully.</message></result>";
}else{
