...
var bkElement = bkClass.extend({
	...
	pos : function() {
		...
		return [$(this).offset().left,$(this).offset().top+10];
	},
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '100%', border : '1px solid #cccccc', backgroundColor : '#efefef'}).addClass('panelContain').addClass("fixme");
		this.panelElm = new bkElement('DIV').setStyle({margin : '2px', marginTop : '0px', zoom : 1, overflow : 'hidden'}).addClass('panel').addClass("fixme").appendTo(this.panelContain);
...
var nicUploadOptions = {
	buttons : {
		'table' : {name : 'Add Table', type : 'nicTableButton'},iconFiles : {'table' : 'icon-table.png'}
	}
...
var nicTableButton = nicEditorAdvancedButton.extend({
	...
	addPane : function() {
		this.addForm({
			...
			'cols' : {type : 'text', txt : 'Columns', 'value' : '1', style : {width: '150px'}},
			'rows' : {type : 'text', txt : 'Rows', style : {width: '100px'}},
			'border' : {type : 'text', txt : 'Border', style : {width: '100px'}},
			'padding' : {type : 'text', txt : 'Padding', style : {width: '100px'}},
			'spacing' : {type : 'text', txt : 'Spacing', style : {width: '100px'}}
		});
	},
	submit : function(e) {
		var code = "<table border=\""+this.inputs['border'].value+"\" cellspacing=\""+this.inputs['spacing'].value+"\" cellpadding=\""+this.inputs['padding'].value+"\">";
		for( var i=0; i<parseInt(this.inputs['rows'].value); i++ ){
			code += "<tr>";
				for( var g=0; g<parseInt(this.inputs['cols'].value); g++ ){
					code += "<td></td>";
				}
			code += "</tr>";
		}
