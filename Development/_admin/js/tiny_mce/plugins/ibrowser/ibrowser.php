...
<script language="JavaScript" type="text/JavaScript"> 
	...
	function validateParams() {
		var libbrowser = document.getElementById('libbrowser');
...
// set picture attributes on change
	...
	{
		var formObj = document.getElementById('libbrowser');
//		dumpProps(obj);
...
<form name="libbrowser" id="libbrowser" method="post" action="ibrowser.php?request_uri=<?php echo $HTTP_GET_VARS['request_uri']?>" enctype="multipart/form-data" target="imglibrary">
  ...
  <table width="440" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%"  border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td><?php 
      $_root = $GLOBALS['__CONFIG_']['__paths_']['__installationPath_'].'/clients'.$GLOBALS['__CONFIG_']['__paths_']['__clientPath_'].'/'.$GLOBALS['__CONFIG_']['__paths_']['__httpPath_'].'/';
	  $d = @dir($_root.$imglib);
  ?>
