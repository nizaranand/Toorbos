...
$__APPLICATION_['channel'] = new channel(array('in'=>array('path'=>'sites','section'=>'export', 'skin' => 'export.tpl')));
...
$__APPLICATION_['channel']->channelReplace('<var:modulesToExport>',$modulesToExport);
