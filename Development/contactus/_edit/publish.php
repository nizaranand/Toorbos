...
$__APPLICATION_['channel'] = new channel(array ('in' => array ('path' => 'sites', 'section' => 'editcontent', 'skin' => 'publish.tpl')));
...
switch( $cmd ){
	case 'publishtree':
		$__APPLICATION_['database']->__runQueryByCode_( '__runquery_','CQUpdatePublished',array('mod_content_id'=>$mod_content_id,'published'=>1,'tableName'=>$tableName));
		$__APPLICATION_['database']->__runQueryByCode_( '__runquery_','MQUpdatePublished',array('sys_tree_id'=>$sys_tree_id,'published'=>1));
